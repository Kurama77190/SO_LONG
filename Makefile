...
#    Updated: 2024/06/17 05:54:04 by sben-tay         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/Mandatory/main.c \
	...
	$(LIB)ft_malloc.c $(LIB)img_with_transparency.c $(LIB)ft_strslen.c $(LIB)load_image.c \
	$(INIT)init_game.c $(INIT)init_animation.c \
