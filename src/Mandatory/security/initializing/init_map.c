...
/*   Updated: 2024/06/20 02:23:32 by sben-tay         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->map = read_map(data, "src/Mandatory/img/maps/map.ber", &data->map_width, &data->map_height);
...
void	draw_map(t_game *data)
{
	...
	int i = 0;
	int j = 0;
	mlx_put_pixel_to_image
	data->bg_img->addr =  mlx_get_data_addr(data->bg_img->addr, &data->bg_img->bpp, &data->bg_img->line_length, &data->bg_img->endian);
